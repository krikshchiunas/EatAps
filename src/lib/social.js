...
// всё, что связано с графом «кто кому кто» и с лентой. Чтение списка друзей
// остаётся в supabase.js, потому что вокруг него построен чат, — но саму
// дружбу создают и расторгают follow/unfollow отсюда: с 2026-08-26 друзья —
// это те, кто подписан друг на друга.
//
