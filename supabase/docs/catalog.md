...
| `conversation_info` | `p_conversation uuid` | table ( id uuid, kind text, title text, avatar_url text, created_by uuid, created_at timestamptz, my_role text, my_state text, archived boolean, muted_until timestamptz, peer_id uuid, members_count int, media_count int ) | definer, stable | authenticated | 2026-09-09_conversations.sql | src/lib/messaging.js |
